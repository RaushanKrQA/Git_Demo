...
public class StandAloneTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("userEmail")).sendKeys("rana@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Ranabhai@1");
		...
		//Thread.sleep(3000);
		int y = driver.findElement(By.cssSelector(".action__submit")).getLocation().getY();
